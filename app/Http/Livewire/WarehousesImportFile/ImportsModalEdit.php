...
class ImportsModalEdit extends Modal
{
    ...
    public $title = 'Import Mag./Ubic. da XLS';
    ...
    {
        return view('livewire.warehouses-import-file.imports-modal-edit');
    }
    ...
    public function save()
    {
        ...
        //TODO Avvia JOb
        WarehouseJobImport::dispatch($importFile->id)->onQueue('importFiles');

        Notification::send(Auth::user(), new DefaultMessageNotify(
            $title = 'Import Magazzini',
