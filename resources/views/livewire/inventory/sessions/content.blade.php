    ...
    <x-slot:content>
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Lista Sessioni Inventario</h3>
            ...
            <div class="card-body">
                ...
                @endif --}}
                <div style="">
                    <livewire:inventory.sessions.inv-sessions-table />
                </div>
            </div>
        </div>
    </x-slot:content>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <button class="btn btn-outline-success btn-block"
                    onclick="Livewire.emit('modal.open', 'inventory.sessions.inv-session-modal-edit')">
                    <span class="fa fa-edit"></span> Crea Sessione Inventariale
                </button>
                {{-- @endpermission --}}
            </div>
        </div>
