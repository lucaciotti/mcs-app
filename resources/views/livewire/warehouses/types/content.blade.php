    ...
    <x-slot:content>
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Lista reparti magazzino</h3>
            ...
            <div class="card-body">
                ...
                {{-- @endif --}}
                <div style="">
                    <livewire:warehouses.types.type-table warehouse_id='{{ $warehouse->id }}'/>
                </div>
            </div>
        </div>
    </x-slot:content>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <button class="btn btn-outline-success btn-block"
                    onclick="Livewire.emit('modal.open', 'warehouses.types.type-modal-edit',{'id': null, 'warehouse_id': {{ $warehouse->id }}})">
                    <span class="fa fa-edit"></span> Crea Reparto
                </button>
                {{-- @endpermission --}}
            </div>
        </div>
